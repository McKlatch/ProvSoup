...
<social-button :label="label" :origin="origin" :proverb="proverb" :source="source" :clickURL="`https://facebook.com/sharer/sharer.php?u=https%3A%2F%2Fproverbialsoup.com/${label}/`" buttonClass="" titleText="Share on Facebook"><i class="lab la-facebook" style="color:#3b5998;font-style:normal;"></i></i></social-button>

<social-button :label="label" :origin="origin" :proverb="proverb" :source="source" :clickURL="`https://twitter.com/intent/tweet/?text=${proverb}&amp;url=https%3A%2F%2Fproverbialsoup.com/${label}/`" buttonClass="" titleText="Tweet this"><i class="lab la-twitter" style="color:#55acee;font-style:normal;"></i></social-button>
...
<social-button :label="label" :origin="origin" :proverb="proverb" :source="source" :clickURL="`mailto:?subject=${proverb}&amp;body=I found this great quote, take a look at the picture: https%3A%2F%2Fproverbialsoup.com/${label}/`" buttonClass="" titleText="Send by E-Mail"><i class="las la-envelope" style="color:#777;font-style:normal;"></i></social-button>

<social-button :label="label" :origin="origin" :proverb="proverb" :source="source" :clickURL="`https://pinterest.com/pin/create/button/?url=https%3A%2F%2Fproverbialsoup.com/${label}/&amp;media=https%3A%2F%2Fproverbialsoup.com${require(`~/assets/img/quotes/${this.label}.png`)}/&amp;description=${proverb}`" buttonClass="" titleText="Pin this"><i class="lab la-pinterest-p" style="color:#bd081c;font-style:normal;"></i></social-button>

<social-button :label="label" :origin="origin" :proverb="proverb" :source="source" :clickURL="`https://www.linkedin.com/shareArticle?mini=true&amp;url=https%3A%2F%2Fproverbialsoup.com/${label}/&amp;title=${proverb}&amp;summary=Beneficial%20sayings%20worth%20repeating%20and%20sharing%20in%20real%20life%20(or%20on%20LinkedIn).&amp;source=https%3A%2F%2Fproverbialsoup.com/${label}/`" buttonClass="" titleText="Share on LinkedIn"><i class="lab la-linkedin" style="color:#0077b5;font-style:normal;"></i></social-button>

<social-button :label="label" :origin="origin" :proverb="proverb" :source="source" :clickURL="`https://reddit.com/submit/?url=https%3A%2F%2Fproverbialsoup.com/${label}/&amp;resubmit=true&amp;title=${proverb}`" buttonClass="" titleText="Post on Reddit"><i class="lab la-reddit" style="color:#FF5700;font-style:normal;"></i></social-button>

<social-button :label="label" :origin="origin" :proverb="proverb" :source="source" :clickURL="`whatsapp://send?text=${proverb}%20https%3A%2F%2Fproverbialsoup.com/${label}/`" buttonClass="" titleText="Share on Whatsapp (phone only)"><i class="lab la-whatsapp" style="color:#25D366;font-style:normal;"></i></social-button>
