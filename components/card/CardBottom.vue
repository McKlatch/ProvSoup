<template>
  <div class="w-full">
    <div class="flex justify-around bg-gray-300">
      <social-button :label="quote.id" :origin="quote.contributor" :proverb="quote.text" :source="quote.citation" :clickURL="`https://facebook.com/sharer/sharer.php?u=https%3A%2F%2Fproverbialsoup.com/${quote.id}/`" buttonClass="" titleText="Share on Facebook"><i class="lab la-facebook" style="color:#3b5998;font-style:normal;"></i></social-button>
