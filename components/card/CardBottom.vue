...
<social-button :label="quote.id" :origin="quote.contributor" :proverb="quote.text" :source="quote.citation" :clickURL="`https://pinterest.com/pin/create/button/?url=https%3A%2F%2Fproverbialsoup.com/${quote.id}/&amp;media=https%3A%2F%2Fproverbialsoup.com${require(`~/assets/img/quotes/${this.quote.id}.png`)}/&amp;description=${quote.text}`" buttonClass="" titleText="Pin this"><i class="lab la-pinterest-p" style="color:#bd081c;font-style:normal;"></i></social-button>
