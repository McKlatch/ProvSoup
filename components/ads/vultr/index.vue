<template>
  <a href="https://www.vultr.com/?ref=8189154" target="_blank" rel="noopener" aria-label="">
    <div class="vultrGrad flex">
      <div class="self-center flex-1 text-center">
        <p class="text-white">High
Performance
SSD
Storage
16
