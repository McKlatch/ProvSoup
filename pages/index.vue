<template>
  <div>
    ...
    <img :src="displayImgURL" :alt="`&quot;${quote.proverb}&quot; - ${quote.origin}`" class="block mx-auto md:w-1/2 m-4 shadow-2xl font-body block text-2xl text-gray-800 text-center">
    <!-- <button class="block text-center bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded items-center">
